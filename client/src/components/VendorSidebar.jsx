...
export default function VendorSidebar({ activePage, setActivePage }) {
  ...
  const navItems = [
    ...
    { label: 'Manage Events', icon: <FaListAlt />, key: 'events' },
  ];
  ...
  return (
    ...
    >
      <div className="p-4 border-b border-gray-300 flex justify-between items-center">
        {!collapsed && (
          <h2 className="text-xl font-semibold text-gray-700">Vendor Panel</h2>
        )}
        <button
